...
/**
 * DEMO CONTENT — every brand below is fictional and drawn in-house, so no
 * real company's marks are used without permission and nothing implies a
 * client relationship that does not exist.
 *
 * To use real logos: replace `glyph` + `name` with an <Image> of the supplied
 * SVG, update the heading to a genuine trust line, and delete the badge.
 */
const BRANDS = [
  {
    name: "Northfield",
  ...
  {
    name: "Vantix",
    glyph: <path d="M9 2.5 16 15.5H2z" fill="currentColor" />,
  },
  {
    name: "Anthemik",
    glyph: <rect x="3.5" y="3.5" width="11" height="11" rx="1" transform="rotate(45 9 9)" fill="currentColor" />,
  },
  {
    name: "Kompass",
    glyph: (
      ...
      <Container>
        ...
        <Reveal delay={140}>
          <div className="mt-7 flex justify-center">
            <PlaceholderBadge>Placeholder brands</PlaceholderBadge>
          </div>
        </Reveal>
      </Container>
    </section>
